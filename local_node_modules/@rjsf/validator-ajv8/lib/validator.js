...
export default class AJV8Validator {
    ...
    isValid(schema, formData, rootSchema) {
        ...
        console.info("XXXXX Validating subschema: %s", JSON.stringify(schema));
        try {
            ...
            if (compiledValidator === undefined) {
                console.info("XXXXX Not found schema: %s with id: %s after merging schemas in compiledValidator: ", JSON.stringify(schema), schemaId);
        ...
        //console.info("XXXXX Remove root schema from ajv: ", rootSchemaId);  
