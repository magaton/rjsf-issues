(function (global, factory) {
  ...
  var AnyOfField = class extends react.Component {
    ...
    constructor(props) {
      ...
      console.info("%%%%% MultiSchemaField constructor ");
      this.state = {
        retrievedOptions,
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      console.info("%%%%% MultiSchemaField componentDidUpdate matchingOption idSchema: ", idSchema);
  ...
  var Form = class extends react.Component {
    ...
    getStateFromProps(props, inputFormData, retrievedSchema) {
      ...
      console.info("%%%% FORM: getStateFromProps retrievedSchema: %s, mustValidate: %s", retrievedSchema !== null || retrievedSchema !== void 0, mustValidate);
